...
public class CrudViewGenerator {
    ...
    private Pane createButtonsPane() {
        ...
        addNewButton = parameter.getAddNextButtonConstructor().generateNode(parameter.getResourceBundle().getString("addnew.button"), FontAwesomeIcon.PLUS_SQUARE); // TODO: Language customizable
